...
async function startHisoka() {
  ...
  const client = sansekaiConnect({
    ...
    browser: ["Wasif Rind BOT", "Chrome", "120.0.0"],
  ...
  client.ev.on("messages.upsert", async (chatUpdate) => {
    ...
    try {
      ...
      require("./wasif")(client, m, chatUpdate, store);
    } catch (err) {
      console.log(err);
    }
  });
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      if (reason === DisconnectReason.badSession) {
        ...
        console.log(`Device Logged Out, Please Delete Folder Session wasifrind and Scan Again.`);
        process.exit();
      ...
      console.log(color(`Owner: ${ownerName} | ${ownerEmail} | ${owner[0]}`, "yellow"));
